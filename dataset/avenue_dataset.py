...
if __name__ == '__main__':
    dataset = AvenueDataset(json_path='/home/lijuntong/workplace/internvl_vad/data/avenue_test.json', 
                          image_path='/home/lijuntong/dataset/Avenue/Avenue19', 
                          text_path='/home/lijuntong/dataset/Avenue/Avenue19/internvl_video_simsce', 
                          train=False)
    ...
    for i, (images, text_feature) in enumerate(dataloader):
        print(images.shape, text_feature.shape)
        break